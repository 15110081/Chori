...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 28, 2016 at 12:15 PM
...
CREATE TABLE IF NOT EXISTS `accessoryconsumption` (
...
CREATE TABLE IF NOT EXISTS `accessoryform` (
...
CREATE TABLE IF NOT EXISTS `accessoryformdetail` (
  `ACCESSORYCODE` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `ACCESSORYFORMCODE` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `CREATOR` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `CREATEDATE` datetime DEFAULT CURRENT_TIMESTAMP
...
CREATE TABLE IF NOT EXISTS `accessorygroup` (
...
CREATE TABLE IF NOT EXISTS `accessoryordersignature` (
...
CREATE TABLE IF NOT EXISTS `accessoryprice` (
...
CREATE TABLE IF NOT EXISTS `accessorysupplier` (
  `ACCSUPPLIERCODE` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
...
('AS0001', 'admin', 'Equifax', 'Equifax Company', '62 Tan Thanh St, Tan Phu Dis', '083242232', '123125354', '432534532', 'behuuhuan@gmail.com', 'Active', '2016-10-07 10:26:18', ''),
('AS0002', 'admin', 'Genentech', 'Genentech Company', '62 Tan Thanh St, Tan Phu Dis', '083242232', '123125354', '432534532', NULL, 'Active', '2016-11-28 14:02:16', ''),
('AS0003', 'admin', 'Aurora', 'AURORA ACCESSORY SUPPLIER', '62 Tan Thanh St, Tan Phu Dis', '083242232', '1231253543', '43253453245', NULL, 'Active', '2016-11-28 14:02:22', '');
...
CREATE TABLE IF NOT EXISTS `accessorysuppliercontact` (
...
CREATE TABLE IF NOT EXISTS `ctnrtype` (
...
CREATE TABLE IF NOT EXISTS `externalaccessorystock` (
...
(15, 'Lot1_3', NULL, NULL, 12800),
(16, NULL, 'BTNR', 'FAC0001', 200);
...
CREATE TABLE IF NOT EXISTS `fabricinformation` (
...
CREATE TABLE IF NOT EXISTS `fabricinformationdetail` (
  `FABRICNO` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `COLORCODE` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `CREATOR` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `fabricsupplier` (
...
CREATE TABLE IF NOT EXISTS `fabricsuppliercontact` (
...
CREATE TABLE IF NOT EXISTS `factoryaccountinformation` (
...
CREATE TABLE IF NOT EXISTS `fpi` (
...
CREATE TABLE IF NOT EXISTS `fpidetail` (
...
CREATE TABLE IF NOT EXISTS `garmentconsumption` (
...
CREATE TABLE IF NOT EXISTS `garmentconsumptiondetail` (
...
CREATE TABLE IF NOT EXISTS `garmentkind` (
...
CREATE TABLE IF NOT EXISTS `garmentstyle` (
...
CREATE TABLE IF NOT EXISTS `garmentstyleaccessorydetail` (
...
CREATE TABLE IF NOT EXISTS `logofchange` (
...
CREATE TABLE IF NOT EXISTS `orderexternalaccessory` (
...
CREATE TABLE IF NOT EXISTS `orderinternalaccessory` (
  `ORDERSHEETNO` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `ACCSUPPLIERCODE` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL,
  `FACTORYCODE` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL,
  `CREATOR` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `orderinternalaccessorydetail` (
  `ACCESSORYCODE` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `ORDERSHEETNO` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `CREATOR` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `ORDERQUANTITY` int(11) DEFAULT NULL,
...
('Lot4', 'Bangkok', 'FAC0001', 'Asafa', 'Asafa', 'admin', 1136, 0, '2016-09-06 00:00:00', '2016-11-29 00:00:00', NULL, 'Urgent', NULL, 'sewingguide', 'packingguide', 'Remark for Lot4', '2016-10-19 16:28:10', 'No', 6, '2016-11-07 00:00:00', '2016-11-29 00:00:00'),
...
CREATE TABLE IF NOT EXISTS `piassignexternalaccessory` (
...
(34, 'Lot1', 'BTNR', 'Lot1_3', NULL, 'admin', 'Middle East', 'CB', 1, 3850, 10000, 500, 4000, NULL, NULL, '2016-11-19 13:47:28', 15, NULL),
(35, 'Lot1', 'BTNR', 'Lot1_3', NULL, 'admin', 'South', 'CR', 4, 6060, 10000, 500, 6000, NULL, NULL, '2016-11-19 13:47:28', 11, NULL),
(36, 'Lot1', 'BTNR', 'Lot1_3', NULL, 'admin', 'Middle East', 'CB', 5, 5020, NULL, 500, NULL, NULL, NULL, '2016-11-26 17:15:57', 16, NULL);
...
CREATE TABLE IF NOT EXISTS `piassignfabric` (
  `LOTNUMBER` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `FABRICNO` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `CREATOR` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `CREATEDATE` datetime DEFAULT CURRENT_TIMESTAMP
...
('Lot1', 'A3', 'admin', '2016-11-28 11:00:07'),
...
CREATE TABLE IF NOT EXISTS `piassignfabricdetail` (
...
CREATE TABLE IF NOT EXISTS `piassigninternalaccessories` (
...
CREATE TABLE IF NOT EXISTS `piassigninternalaccessoriesdetail` (
...
CREATE TABLE IF NOT EXISTS `piassigninternalaccessoriesoforders` (
...
CREATE TABLE IF NOT EXISTS `pigrid` (
...
(1136, 'admin', '2016-11-28 11:11:38');
...
CREATE TABLE IF NOT EXISTS `pigriddetail` (
...
(217, 1136, 34, 'Middle East', 'CB', 'BC4515', 300, NULL),
(218, 1136, 36, 'Northen West', 'CB', 'BC1113', 100, NULL),
(219, 1136, 37, 'Northen West', 'CB', 'BC4515', 100, NULL),
(220, 1136, 38, 'Northen West', 'CB', 'BC4535', 150, NULL);
...
CREATE TABLE IF NOT EXISTS `rfpi` (
...
CREATE TABLE IF NOT EXISTS `rfpidetail` (
...
CREATE TABLE IF NOT EXISTS `shippingline` (
...
CREATE TABLE IF NOT EXISTS `shippinglinecontact` (
...
ALTER TABLE `accessory`
 ADD PRIMARY KEY (`ACCESSORYCODE`), ADD KEY `FK_ACCESSORY_REFERENCE_CONTAINERUNIT` (`CONTAINERUNITCODE`), ADD KEY `FK_ACCESSORY_REFERENCE_ACCESSORYGROUP` (`ACCESSORYGROUPCODE`), ADD KEY `FK_ACCESSORY_REFERENCE_USER` (`CREATOR`), ADD KEY `FK_ACCESSORY_REFERENCE_UNIT` (`UNITCODE`), ADD KEY `FK_ACCESSORY_REFERENCE_COLOR` (`COLORCODE`);

--
-- Indexes for table `accessoryconsumption`
--
ALTER TABLE `accessoryconsumption`
 ADD PRIMARY KEY (`FACTORYCODE`,`ACCESSORYCODE`), ADD KEY `FK_ACCESSORYCONSUMPTION_REFERENCE_USER` (`CREATOR`), ADD KEY `FK_ACCESSORYCONSUMPTION_REFERENCE_ACCESSOR` (`ACCESSORYCODE`);

--
-- Indexes for table `accessoryform`
--
ALTER TABLE `accessoryform`
 ADD PRIMARY KEY (`ACCESSORYFORMCODE`), ADD KEY `FK_ACCESSORYFORM_REFERENCE_USER` (`CREATOR`);

--
-- Indexes for table `accessoryformdetail`
--
ALTER TABLE `accessoryformdetail`
 ADD PRIMARY KEY (`ACCESSORYCODE`,`ACCESSORYFORMCODE`), ADD KEY `FK_ACCESSORYFORMDETAIL_REFERENCE_ACCESSORFORM` (`ACCESSORYFORMCODE`), ADD KEY `FK_ACCESSORYFORMDETAIL_REFERENCE_USER` (`CREATOR`);

--
-- Indexes for table `accessorygroup`
--
ALTER TABLE `accessorygroup`
 ADD PRIMARY KEY (`ACCESSORYGROUPCODE`), ADD KEY `FK_ACCESSORYGROUP_REFERENCE_USER` (`CREATOR`);

--
-- Indexes for table `accessoryordersignature`
--
ALTER TABLE `accessoryordersignature`
 ADD PRIMARY KEY (`ACCORDERSIGNCODE`), ADD KEY `FK_ACCESSORYORDERSIGNATURE_REFERENCE_USER` (`CREATOR`);

--
-- Indexes for table `accessoryprice`
--
ALTER TABLE `accessoryprice`
 ADD PRIMARY KEY (`ACCESSORYPRICECODE`), ADD KEY `FK_ACCESSORYPRICE_REFERENCE_ACCESSORY` (`ACCESSORYCODE`), ADD KEY `FK_ACCESSORYPRICE_REFERENCE_ACCESSORYSUPPLIER` (`ACCSUPPLIERCODE`), ADD KEY `FK_ACCESSORYPRICE_REFERENCE_CURRENCY` (`CURRENCYCODE`), ADD KEY `FK_ACCESSORYPRICE_REFERENCE_USER` (`CREATOR`);

--
-- Indexes for table `accessorysupplier`
--
ALTER TABLE `accessorysupplier`
 ADD PRIMARY KEY (`ACCSUPPLIERCODE`), ADD KEY `FK_ACCESSORYSUPPLIER_REFERENCE_USER` (`CREATOR`);

--
-- Indexes for table `accessorysuppliercontact`
--
ALTER TABLE `accessorysuppliercontact`
 ADD PRIMARY KEY (`ACCSUPPLIERCONTACTCODE`), ADD KEY `FK_ACCESSORYSUPPLIERCONTACT_REFERENCE_USER` (`CREATOR`), ADD KEY `FK_ACCESSORYSUPPLIERCONTACT_REFERENCE_ACCESSORYSUPPLIER` (`ACCSUPPLIERCODE`);

--
-- Indexes for table `agent`
--
ALTER TABLE `agent`
 ADD PRIMARY KEY (`AGENTCODE`), ADD KEY `FK_AGENT_REFERENCE_USER` (`CREATOR`);

--
-- Indexes for table `agentcontact`
--
ALTER TABLE `agentcontact`
 ADD PRIMARY KEY (`AGENTCONTACTCODE`), ADD KEY `FK_AGENTCONTACT_REFERENCE_AGENT` (`AGENTCODE`), ADD KEY `FK_AGENTCONTACT_REFERENCE_USER` (`CREATOR`);

--
-- Indexes for table `brand`
--
ALTER TABLE `brand`
 ADD PRIMARY KEY (`BRANDCODE`), ADD KEY `FK_BRAND_REFERENCE_USER` (`CREATOR`), ADD KEY `FK_BRAND_REFERENCE_CUSTOMER` (`CUSTOMERCODE`);

--
-- Indexes for table `color`
--
ALTER TABLE `color`
 ADD PRIMARY KEY (`COLORCODE`), ADD KEY `FK_COLOR_REFERENCE_USER` (`CREATOR`);

--
-- Indexes for table `ctnrtype`
--
ALTER TABLE `ctnrtype`
 ADD PRIMARY KEY (`CTNRCODE`), ADD KEY `FK_CTNRTYPE_REFERENCE_USER` (`CREATOR`);

--
-- Indexes for table `currency`
--
ALTER TABLE `currency`
 ADD PRIMARY KEY (`CURRENCYCODE`), ADD KEY `FK_CURRENCY_REFERENCE_USER` (`CREATOR`);

--
-- Indexes for table `currencyexchange`
--
ALTER TABLE `currencyexchange`
 ADD PRIMARY KEY (`CURRENCYEXCODE`), ADD KEY `FK_CUREXSOURCE_REFERENCE_CURRENCY` (`CURRENCYCODESOURCE`), ADD KEY `FK_CURREXDESTINATION_REFERENCE_CURRENCY` (`CURRENCYCODEDESTINATION`);

--
-- Indexes for table `customer`
--
ALTER TABLE `customer`
 ADD PRIMARY KEY (`CUSTOMERCODE`), ADD KEY `FK_CUSTOMER_REFERENCE_USER` (`CREATOR`);

--
-- Indexes for table `customeraccountinformation`
--
ALTER TABLE `customeraccountinformation`
 ADD PRIMARY KEY (`CUSTOMERACCOUNTINFOCODE`), ADD KEY `FK_CUSTOMERACCOUNTINFO_REFERENCE_USER` (`CREATOR`), ADD KEY `FK_CUSTOMERACCOUNTINFO_REFERENCE_CUSTOMER` (`CUSTOMERCODE`);

--
-- Indexes for table `customercontact`
--
ALTER TABLE `customercontact`
 ADD PRIMARY KEY (`CUSCONTACTCODE`), ADD KEY `FK_CUSTOMER_REFERENCE_CUSTOMER` (`CUSTOMERCODE`), ADD KEY `FK_CUSTOMERCONTACT_REFERENCE_USER` (`CREATOR`);

--
-- Indexes for table `destination`
--
ALTER TABLE `destination`
 ADD PRIMARY KEY (`DESTINATIONCODE`), ADD KEY `FK_DESTINAT_REFERENCE_USER` (`CREATOR`);

--
-- Indexes for table `estimatetime`
--
ALTER TABLE `estimatetime`
 ADD PRIMARY KEY (`ESTIMATETIMECODE`), ADD KEY `FK_ESTIMATETIME_REFERENCE_USER` (`CREATOR`);

--
-- Indexes for table `externalaccessorystock`
--
ALTER TABLE `externalaccessorystock`
 ADD PRIMARY KEY (`EXTERNALACCESSORYSTOCKCODE`), ADD KEY `FK_EXTERNALACCSTOCK_REFERENCE_ORDEREXTERNALACCESSORY` (`ORDERSHEETNO`), ADD KEY `FK_EXTERNALACCSTOCK_REFERENCE_ACCESSORY` (`ACCESSORYCODE`), ADD KEY `FK_EXTERNALACCSTOCK_REFERENCE_FACTORY` (`FACTORYCODE`);

--
-- Indexes for table `fabricinformation`
--
ALTER TABLE `fabricinformation`
 ADD PRIMARY KEY (`FABRICNO`), ADD KEY `FK_FABRICINFORMATION_REFERENCE_CUSTOMER` (`CUSTOMERCODE`), ADD KEY `FK_FABRICINFORMATION_REFERENCE_FABRICSUPPLIER` (`FABRICSUPCODE`), ADD KEY `FK_FABRICINFORMATION_REFERENCE_FACTORY` (`FACTORYCODE`), ADD KEY `FK_FABRICINFORMATION_REFERENCE_CURRENCY` (`CURRENCYCODE`), ADD KEY `FK_FABRICINFORMATION_REFERENCE_WIDTH` (`WIDTHCODE`), ADD KEY `FK_FABRICINFORMATION_REFERENCE_USER` (`CREATOR`), ADD KEY `FK_FABRICINFORMATION_REFERENCE_AGENT` (`AGENTCODE`);

--
-- Indexes for table `fabricinformationdetail`
--
ALTER TABLE `fabricinformationdetail`
 ADD PRIMARY KEY (`FABRICNO`,`COLORCODE`), ADD KEY `FK_FABRICINFORMATIONDEATIL_REFERENCE_COLOR` (`COLORCODE`), ADD KEY `FK_FABRICINFORMATIONDETAIL_REFERENCE_USER` (`CREATOR`);

--
-- Indexes for table `fabricsupplier`
--
ALTER TABLE `fabricsupplier`
 ADD PRIMARY KEY (`FABRICSUPCODE`), ADD KEY `FK_FABRICSUPPLIER_REFERENCE_USER` (`CREATOR`);

--
-- Indexes for table `fabricsuppliercontact`
--
ALTER TABLE `fabricsuppliercontact`
 ADD PRIMARY KEY (`FABRICSUPPLIERCONTACTCODE`), ADD KEY `FK_FABRICSUPPLIERCONTACT_REFERENCE_USER` (`CREATOR`), ADD KEY `FK_FABRICSUPPLIERCONTACT_REFERENCE_FABRICSU` (`FABRICSUPPLIERCODE`);

--
-- Indexes for table `factory`
--
ALTER TABLE `factory`
 ADD PRIMARY KEY (`FACTORYCODE`), ADD KEY `FK_FACTORY_REFERENCE_USER` (`CREATOR`);

--
-- Indexes for table `factoryaccountinformation`
--
ALTER TABLE `factoryaccountinformation`
 ADD PRIMARY KEY (`FACTORYACCOUNTINFOCODE`), ADD KEY `FK_FACTORYACCOUNTINFO_REFERENCE_USER` (`CREATOR`), ADD KEY `FK_FACTORYACCOUNTINFO_REFERENCE_FACTORY` (`FACTORYCODE`);

--
-- Indexes for table `factorycontact`
--
ALTER TABLE `factorycontact`
 ADD PRIMARY KEY (`FACTORYCONTACTCODE`), ADD KEY `FK_FACTORYCONTACT_REFERENCE_USER` (`CREATOR`), ADD KEY `FK_FACTORYCONTACT_REFERENCE_FACTORY` (`FACTORYCODE`);

--
-- Indexes for table `fpi`
--
ALTER TABLE `fpi`
 ADD PRIMARY KEY (`FPICODE`), ADD KEY `FK_FPI_REFERENCE_USER` (`CREATOR`), ADD KEY `FK_FPI_REFERENCE_PI` (`LOTNUMBER`);

--
-- Indexes for table `fpidetail`
--
ALTER TABLE `fpidetail`
 ADD PRIMARY KEY (`FPIDETAILCODE`), ADD KEY `FK_FPIDETAI_REFERENCE_FPI` (`FPICODE`), ADD KEY `FK_FPIDETAI_REFERENCE_COLOR` (`COLORCODE`), ADD KEY `FK_FPIDETAI_REFERENCE_GARMENTS` (`GARMENTSTYLECODE`), ADD KEY `FK_FPIDETAI_REFERENCE_SIZE` (`SIZECODE`);
...
ALTER TABLE `garmentconsumption`
 ADD PRIMARY KEY (`GARMENTCONSUMPTIONCODE`), ADD KEY `FK_GARMENTCONSUMPTION_REFERENCE_SIZE` (`SIZECODE`), ADD KEY `FK_GARMENTCONSUMPTION_REFERENCE_GARMENTS` (`GARMENTSTYLECODE`), ADD KEY `FK_GARMENTCONSUMPTION_REFERENCE_USER` (`CREATOR`), ADD KEY `FK_GARMENTCONSUMPTION_REFERENCE_CUSTOMER` (`CUSTOMERCODE`);

--
-- Indexes for table `garmentconsumptiondetail`
--
ALTER TABLE `garmentconsumptiondetail`
 ADD PRIMARY KEY (`GARMENTCONSUMPTIONDETAILCODE`), ADD KEY `FK_GARMENTCONSUMPTIONDETAIL_REFERENCE_GARMENTC` (`GARMENTCONSUMPTIONCODE`), ADD KEY `FK_GARMENTCONSUMPTIONDETAIL_REFERENCE_WIDTH` (`WIDTHCODE`), ADD KEY `FK_GARMENTCONSUMPTIONDETAIL_REFERENCE_USER` (`CREATOR`);

--
-- Indexes for table `garmentkind`
--
ALTER TABLE `garmentkind`
 ADD PRIMARY KEY (`GARMENTKINDCODE`), ADD KEY `FK_GARMENTKIND_REFERENCE_USER` (`CREATOR`);

--
-- Indexes for table `garmentstyle`
--
ALTER TABLE `garmentstyle`
 ADD PRIMARY KEY (`GARMENTSTYLECODE`), ADD KEY `FK_GARMENTSTYLE_REFERENCE_FACTORY` (`FACTORYCODE`), ADD KEY `FK_GARMENTSTYLE_REFERENCE_GARMENTKIND` (`GARMENTKINDCODE`), ADD KEY `FK_GARMENTSTYLE_REFERENCE_CUSTOMER` (`CUSTOMERCODE`), ADD KEY `FK_GARMENTSTYLE_REFERENCE_USER` (`CREATOR`);

--
-- Indexes for table `garmentstyleaccessorydetail`
--
ALTER TABLE `garmentstyleaccessorydetail`
 ADD PRIMARY KEY (`GARMENTSTYLEACCESSORYDETAILCODE`), ADD KEY `FK_GARMENTSTYLEACCESSORYDETAIL_REFERENCE_GARMENTS` (`GARMENTSTYLECODE`), ADD KEY `FK_GARMENTSTYLEACCESSORYDETAIL_REFERENCE_ACCESSOR` (`ACCESSORYCODE`), ADD KEY `FK_GARMENTSTYLEACCESSORYDETAIL_REFERENCE_SIZE` (`SIZECODE`), ADD KEY `FK_GARMENTSTYLEACCESSORYDETAIL_REFERENCE_USER` (`CREATOR`);

--
-- Indexes for table `logofchange`
--
ALTER TABLE `logofchange`
 ADD PRIMARY KEY (`LOGOFCHANGECODE`), ADD KEY `FK_LOGOFCHANGE_REFERENCE_PI` (`LOTNUMBER`);

--
-- Indexes for table `orderexternalaccessory`
--
ALTER TABLE `orderexternalaccessory`
 ADD PRIMARY KEY (`ORDERSHEETNO`), ADD KEY `FK_ORDEREXTERNALACCESSORY_REFERENCE_USER` (`CREATOR`), ADD KEY `FK_ORDEREXTERNALACCESSORY_REFERENCE_ACCESSORYSUPPLIER` (`ACCSUPPLIERCODE`), ADD KEY `FK_ORDEREXTERNALACCESSORY_REFERENCE_FACTORY` (`FACTORYCODE`), ADD KEY `FK_ORDEREXTERNALACCESSORY_REFERENCE_ACCESSORY` (`ACCESSORYCODE`);

--
-- Indexes for table `orderinternalaccessory`
--
ALTER TABLE `orderinternalaccessory`
 ADD PRIMARY KEY (`ORDERSHEETNO`), ADD KEY `FK_ORDERINTERNALACCESSORY_REFERENCE_ACCESSORYSUPPLIER` (`ACCSUPPLIERCODE`), ADD KEY `FK_ORDERINTERNALACCESSORY_REFERENCE_FACTORY` (`FACTORYCODE`), ADD KEY `FK_ORDERINTERNALACCESSORY_REFERENCE_USER` (`CREATOR`);

--
-- Indexes for table `orderinternalaccessorydetail`
--
ALTER TABLE `orderinternalaccessorydetail`
 ADD PRIMARY KEY (`ACCESSORYCODE`,`ORDERSHEETNO`), ADD KEY `FK_ORDERINTERNALACCESSORYDETAIL_REFERENCE_ORDERINTERNALACC` (`ORDERSHEETNO`), ADD KEY `FK_ORDERINTERNALACCESSORYDETAIL_REFERENCE_USER` (`CREATOR`);

--
-- Indexes for table `packingguide`
--
ALTER TABLE `packingguide`
 ADD PRIMARY KEY (`Code`), ADD KEY `FK_PACKINGGUIDE_REFERENCE_USER` (`CREATOR`);

--
-- Indexes for table `pi`
--
ALTER TABLE `pi`
 ADD PRIMARY KEY (`LOTNUMBER`), ADD KEY `FK_PI_REFERENCE_PIGRID` (`PIGRIDCODE`), ADD KEY `FK_PI_REFERENCE_USER` (`CREATOR`), ADD KEY `FK_PI_REFERENCE_DESTINATION` (`DESTINATIONCODE`), ADD KEY `FK_PI_REFERENCE_FACTORY` (`FACTORYCODE`), ADD KEY `FK_PICUSTOMER1_REFERENCE_CUSTOMER` (`CUSTOMER1CODE`), ADD KEY `FK_PICONSIGNEE_REFERENCE_CUSTOMER` (`CONSIGNEEE`), ADD KEY `FK_PIBRAND_REFERENCE_BRAND` (`BRANDCODE`), ADD KEY `FK_PI_REFERENCE_PACKINGGUIDE` (`PACKINGGUIDE`);

--
-- Indexes for table `piassignexternalaccessory`
--
ALTER TABLE `piassignexternalaccessory`
 ADD PRIMARY KEY (`PIASSIGNEXTERNALACCESSORYCODE`), ADD KEY `FK_PIASSIGNEXTERNALACCESSORY_REFERENCE_PI` (`LOTNUMBER`), ADD KEY `FK_PIASSIGNEXTERNALACCESSORY_REFERENCE_ACCESSORY` (`ACCESSORYCODE`), ADD KEY `FK_PIASSIGNEXTERNALACCESSORY_REFERENCE_USER` (`CREATOR`), ADD KEY `FK_PIASSIGNEXTERNALACCESSORY_REFERENCE_ORDEREXTERNALACCESSORY` (`ORDERSHEETNO`), ADD KEY `FK_PIASSIGNEXTERNALACCESSORY_REFERENCE_EXTERNALACCSTOCK` (`EXTERNALACCESSORYSTOCKCODE`), ADD KEY `FK_PIASSIGNEXTERNALACCESSORY_REFERENCE_GARMENTSTYLE` (`GARMENTSTYLECODE`), ADD KEY `FK_PIASSIGNEXTERNALACCESSORY_REFERENCE_COLOR` (`COLORCODE`), ADD KEY `FK_PIASSIGNEXTERNALACC_REFERENCE_GARMENTSTYLEACCDETAIL` (`GARMENTSTYLEACCESSORYDETAILCODE`), ADD KEY `FK_PIASSIGNEXTERNALACC_REFERENCE_PIGRIDDETAIL` (`PIGRIDDETAIL`);

--
-- Indexes for table `piassignfabric`
--
ALTER TABLE `piassignfabric`
 ADD PRIMARY KEY (`LOTNUMBER`,`FABRICNO`), ADD KEY `FK_PIASSIGN_REFERENCE_USER` (`CREATOR`), ADD KEY `FK_PIASSIGNFABRIC_REFERENCE_FABRICINFORMATION` (`FABRICNO`);

--
-- Indexes for table `piassignfabricdetail`
--
ALTER TABLE `piassignfabricdetail`
 ADD PRIMARY KEY (`PIASSIGNFABRICDETAILCODE`), ADD KEY `FK_PIASSIGNFABRICDETAIL_REFERENCE_COLOR` (`COLORCODE`), ADD KEY `FK_PIASSIGNFABRICDETAIL_REFERENCE_PIASSIGNFABRIC` (`LOTNUMBER`,`FABRICNO`), ADD KEY `FK_PIASSIGNFABRICDETAIL_REFERENCE_GARMENTSTYLE` (`GARMENTSTYLECODE`);

--
-- Indexes for table `piassigninternalaccessories`
--
ALTER TABLE `piassigninternalaccessories`
 ADD PRIMARY KEY (`PIINTERNALACCESSORIES`), ADD KEY `FK_PIORDERINTERNALACC_REFERENCE_PI` (`LOTNUMBER`), ADD KEY `FK_PIORDERINTERNALACC_REFERENCE_ACCESSORY` (`ACCESSORYCODE`), ADD KEY `FK_PIORDERINTERNALACC_REFERENCE_USER` (`CREATOR`);

--
-- Indexes for table `piassigninternalaccessoriesdetail`
--
ALTER TABLE `piassigninternalaccessoriesdetail`
 ADD PRIMARY KEY (`PIINTERNALACCDETAILCODE`), ADD KEY `FK_PIORDERINTERNALACCDEATIL_REFERENCE_PIORDERINTERNALACC` (`PIINTERNALACCESSORIES`), ADD KEY `FK_PIORDERINTERNALACCDETAIL_REFERENCE_GARMENTSTYLE` (`GARMENTSTYLECODE`), ADD KEY `FK_PIORDERINTERNALACCDETAIL_REFERENCE_SIZE` (`SIZECODE`), ADD KEY `FK_PIORDERINTERNALACCDETAIL_REFERENCE_COLOR` (`COLORCODE`);

--
-- Indexes for table `piassigninternalaccessoriesoforders`
--
ALTER TABLE `piassigninternalaccessoriesoforders`
 ADD PRIMARY KEY (`PIASSIGNINTERNALACCESSORIESOFORDERSCODE`), ADD KEY `FK_PIASSIGNINTACCORDERS_REF_PIASSIGNINTACC` (`PIINTERNALACCESSORIES`), ADD KEY `FK_PIASSIGNINTACCORDER_REF_ORDERINTACC` (`ORDERSHEETNO`);

--
-- Indexes for table `pigrid`
--
ALTER TABLE `pigrid`
 ADD PRIMARY KEY (`PIGRIDCODE`), ADD KEY `FK_PIGRID_REFERENCE_USER` (`CREATOR`);

--
-- Indexes for table `pigriddetail`
--
ALTER TABLE `pigriddetail`
 ADD PRIMARY KEY (`PIGRIDDETAIL`), ADD KEY `FK_PIGRIDDE_REFERENCE_SIZE` (`SIZECODE`), ADD KEY `FK_PIGRIDDE_REFERENCE_GARMENTS` (`GARMENTSTYLECODE`), ADD KEY `FK_PIGRIDDE_REFERENCE_COLOR` (`COLORCODE`), ADD KEY `FK_PIGRIDDE_REFERENCE_PIGRID` (`PIGRIDCODE`);

--
-- Indexes for table `rfpi`
--
ALTER TABLE `rfpi`
 ADD PRIMARY KEY (`RFPIGRID`), ADD KEY `FK_RFPI_REFERENCE_PI` (`LOTNUMBER`), ADD KEY `FK_RFPI_REFERENCE_USER` (`CREATOR`);

--
-- Indexes for table `rfpidetail`
--
ALTER TABLE `rfpidetail`
 ADD PRIMARY KEY (`RFPIDETAIL`), ADD KEY `FK_RFPIDETA_REFERENCE_RFPI` (`RFPIGRID`), ADD KEY `FK_RFPIDETA_REFERENCE_GARMENTS` (`GARMENTSTYLECODE`), ADD KEY `FK_RFPIDETA_REFERENCE_COLOR` (`COLORCODE`), ADD KEY `FK_RFPIDETA_REFERENCE_SIZE` (`SIZECODE`);

--
-- Indexes for table `role`
--
ALTER TABLE `role`
 ADD PRIMARY KEY (`ROLEID`), ADD KEY `FK_ROLE_REFERENCE_USER` (`CREATOR`);

--
-- Indexes for table `rolefunction`
--
ALTER TABLE `rolefunction`
 ADD PRIMARY KEY (`ROLEID`,`FUNCTIONID`), ADD KEY `FK_ROLEFUNC_REFERENCE_FUNCTION` (`FUNCTIONID`);

--
-- Indexes for table `shippingline`
--
ALTER TABLE `shippingline`
 ADD PRIMARY KEY (`SHIPPINGLINECODE`), ADD KEY `FK_SHIPPING_REFERENCE_USER` (`CREATOR`);

--
-- Indexes for table `shippinglinecontact`
--
ALTER TABLE `shippinglinecontact`
 ADD PRIMARY KEY (`SHIPPINGLINECONTACTCODE`), ADD KEY `FK_SHIPPING_REFERENCE_SHIPPING` (`SHIPPINGLINECODE`), ADD KEY `FK_SHIPPINGLINECONTACT_REFERENCE_USER` (`CREATOR`);

--
-- Indexes for table `size`
--
ALTER TABLE `size`
 ADD PRIMARY KEY (`SIZECODE`), ADD KEY `FK_SIZE_REFERENCE_TYPE` (`TYPECODE`), ADD KEY `FK_SIZE_REFERENCE_USER` (`CREATOR`), ADD KEY `FK_SIZE_REFERENCE_CUSTOMER` (`CUSTOMERCODE`), ADD KEY `FK_SIZE_REFERENCE_GARMENTK` (`GARMENTKINDCODE`);

--
-- Indexes for table `type`
--
ALTER TABLE `type`
 ADD PRIMARY KEY (`TYPECODE`), ADD KEY `FK_TYPE_REFERENCE_USER` (`CREATOR`);
...
--
ALTER TABLE `user`
 ADD PRIMARY KEY (`USERNAME`), ADD KEY `FK_USER_REFERENCE_ROLE` (`ROLEID`), ADD KEY `FK_USER_REFERENCE_AGENT` (`AGENTCODE`), ADD KEY `FK_USER_REFERENCE_USER` (`CREATOR`);

--
-- Indexes for table `width`
--
ALTER TABLE `width`
 ADD PRIMARY KEY (`WIDTHCODE`), ADD KEY `FK_WIDTH_REFERENCE_UNIT` (`UNITCODE`), ADD KEY `FK_WIDTH_REFERENCE_USER` (`CREATOR`);
